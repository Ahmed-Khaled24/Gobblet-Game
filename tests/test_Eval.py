...
def test_get_pieces_score():
    ...
    pieces2 = [Piece(Color.WHITE, PieceSize.LARGE),
               Piece(Color.WHITE, PieceSize.LARGE),
               Piece(Color.BLACK, PieceSize.LARGE),
               None]
    ...
    pieces4 = [Piece(Color.WHITE, PieceSize.LARGE),
               ...
               None,
               None]
    pieces5 = [Piece(Color.BLACK, PieceSize.LARGE),
               Piece(Color.BLACK, PieceSize.LARGE),
               Piece(Color.BLACK, PieceSize.LARGE),
               None]
    ...
    assert eval.get_pieces_score(pieces4) == pieces4[0].size.value * 10 * pieces4[1].size.value * 10
